let fs,resolve,styleTemplate,IndexTemplate,JSTemplate,TSTemplate,TSPropsTemplate,parseIndex;_999‍.x([["createComponent",()=>createComponent]]);_999‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_999‍.w("path",[["resolve",["resolve"],function(v){resolve=v}]]);_999‍.w("./templates/css.template",[["styleTemplate",["styleTemplate"],function(v){styleTemplate=v}]]);_999‍.w("./templates/index.template",[["IndexTemplate",["IndexTemplate"],function(v){IndexTemplate=v}]]);_999‍.w("./templates/js.template",[["JSTemplate",["JSTemplate"],function(v){JSTemplate=v}]]);_999‍.w("./templates/ts.template",[["TSTemplate",["TSTemplate"],function(v){TSTemplate=v}]]);_999‍.w("./templates/ts.template.props",[["TSPropsTemplate",["TSPropsTemplate"],function(v){TSPropsTemplate=v}]]);_999‍.w("./parse.index",[["parseIndex",["parseIndex"],function(v){parseIndex=v}]]);
